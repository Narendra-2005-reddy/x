        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">123 malakpeta, Hyderabad, india</p>
              <p className="office__info">Phone: +919063256472</p>

              <p className="office__info">Email: sasidhar@gmail.com</p>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                sasidhar Reddy. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
